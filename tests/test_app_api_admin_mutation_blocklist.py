...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("POST", "/api/embeddings/models/BAAI/bge-small-en-v1.5/download", "manage_embeddings"),
        ("DELETE", "/api/embeddings/models/BAAI/bge-small-en-v1.5", "manage_embeddings"),
        ("POST", "/api/embeddings/endpoint", "Embedding Settings UI"),
        ("DELETE", "/api/embeddings/endpoint", "manage_embeddings"),
        ...
        ("POST", "/api/presets/custom", "manage_presets"),
        ("POST", "/api/presets/templates", "manage_presets"),
        ("DELETE", "/api/presets/templates/t1", "manage_presets"),
        ("POST", "/api/presets/groups", "manage_presets"),
