...
def setup_cookbook_routes() -> APIRouter:
    ...
    from routes.cookbook_tail_routes import register_cookbook_tail_routes

    register_cookbook_tail_routes(
        router,
        cookbook_state_path=_cookbook_state_path,
        state_for_client=_state_for_client,
        state_for_storage=_state_for_storage,
        diagnose_serve_output=_diagnose_serve_output,
