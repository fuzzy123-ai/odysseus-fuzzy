"""Reminder dispatch helpers for notes routes and background actions."""
...
def set_note_scheduler(task_scheduler) -> None:
    """Set the optional in-app notification scheduler used by reminders."""
