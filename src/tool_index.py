...
BUILTIN_TOOL_DESCRIPTIONS: Dict[str, str] = {
    ...
    "manage_repos": "Registered repository management and intelligence. Use for repo registry list/get, confirmed register/forget/update_policy, read-only Git status, recent commits, diff stat, changed paths, redacted remotes, and gated commit_plan/commit/push_plan/push. commit requires confirmed=true, exact changed_paths, checks_passed=true, and content_reviewed=true. push requires confirmed=true, operator_go=true, live_enabled=true, matching branch_name, matching commit_sha, and remote policy approval. Never reset, merge, delete repo files, or bypass the runners.",
