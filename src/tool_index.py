...
BUILTIN_TOOL_DESCRIPTIONS: Dict[str, str] = {
    ...
    "manage_webhooks": "Webhook management: list, add, delete, enable, or disable webhooks. Mutations require confirmed=true and webhook URLs are masked in output.",
