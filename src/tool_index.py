...
BUILTIN_TOOL_DESCRIPTIONS: Dict[str, str] = {
    ...
    "manage_tokens": "API token management: list, create, or delete API access tokens. create/delete require confirmed=true; newly created token values are shown once.",
