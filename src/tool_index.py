...
BUILTIN_TOOL_DESCRIPTIONS: Dict[str, str] = {
    ...
    "manage_repos": "Registered repository intelligence. Use for Git repo overview, registered repo metadata, read-only status, recent commits, diff stat, changed paths, and redacted remotes. Works only on explicitly registered repos and never stages, commits, pushes, resets, merges, or mutates files.",
