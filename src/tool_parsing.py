...
def _parse_tool_call_block(raw: str) -> Optional[ToolBlock]:
    ...
    mapped = _TOOL_NAME_MAP.get(tool_name) or (tool_name if tool_name in _known_tool_names() else None)
    if not mapped:
        return None
