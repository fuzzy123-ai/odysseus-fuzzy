...
from src.research_handler_storage import ResearchStorageMixin
...
class ResearchHandler(ResearchStorageMixin):
    """Handles research service operations with iterative deep research."""

    _research_json_path = staticmethod(_research_json_path)
    _research_data_dir = staticmethod(lambda: RESEARCH_DATA_DIR)
