...
export function mdToHtml(src, opts) {
  ...
  // Extract inline code spans before link/autolink/HTML passes. Otherwise a URL
  // inside `inline code` can be autolinked and replaced with an allowed-HTML
  // placeholder, corrupting the literal command.
