...
- Telegram-Screenshot-Delivery-Packets verbinden Bildartefakt-Integrity, sicheren Filename/Caption, Dry-run-Preview, Live-Gate-Packet und den Photo-Reply-Gate, bevor ein Screenshot-Transport versucht wird.
...
- Der echte Telegram-Screenshot-Versand bleibt operator-gated; repo-side sind Preview, Live-Gate-Packet und Integrity-/Delivery-Packet aktiv.
