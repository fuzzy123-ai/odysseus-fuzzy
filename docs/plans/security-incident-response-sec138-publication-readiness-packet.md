...
Status: `published_remote_readback_passed`. The owner response `Weiter` at
`2026-07-29T19:09:07+02:00` authorized one exact seven-path commit and one push
to `fuzzy/dev`. That authority was consumed once. It granted no SSH, live
...
## Terminal publication readback

- Revision: `9ea87e67464015cedbeeaada9117899edcab3ae2`
- Parent: `d91b2fb695b32c57235c971e47d4f50e5d7bbb86`
- Tree: `992bb061b311aac8cc537420ee1928bfb15ff7f6`
- Destination: `fuzzy/dev`
- Published paths: exactly `7`
- Published observer SHA-256:
  `af8e688ae86e1406a55f51d521f746d15b9300d399caeaa4698e53bd133bd46c`

The push occurred exactly once. Independent `ls-remote`, tracking-ref, tree,
path-inventory and observer-blob readback all matched. The publication grant is
spent.
