...
def _memory_tree_status(vault_dir: str, args: Dict[str, Any], owner: str, source: Dict[str, Any]) -> Any:
...
def _knowledge_audit(vault_dir: str, args: Dict[str, Any], owner: str, source: Dict[str, Any]) -> Any:
    return audit_knowledge(vault_dir)


def _quarantine_list(vault_dir: str, args: Dict[str, Any], owner: str, source: Dict[str, Any]) -> Any:
    return quarantine_list(vault_dir)


def _raptor_status(vault_dir: str, args: Dict[str, Any], owner: str, source: Dict[str, Any]) -> Any:
...
_OBSIDIAN_VAULT_TOOL_SPECS: List[VaultToolSpec] = [
    ...
    VaultToolSpec("obsidian_memory_status", "Return unified read-only memory readiness with readiness_gate, retrieval_policy, freshness_isolation_flags, raptor_lineage_flags, raptor_write_gate, and warnings across SOMT, Freshness Gate, quarantine, and RAPTOR.", _schema({}), "read", _memory_status),
