...
VAULT_TOOL_SPECS: List[VaultToolSpec] = [
    ...
    VaultToolSpec("obsidian_memory_status", "Return unified read-only memory readiness with readiness_gate, retrieval_policy, freshness_isolation_flags, raptor_lineage_flags, and raptor_write_gate across SOMT, Freshness Gate, quarantine, and RAPTOR.", _schema({}), "read", _memory_status),
